...
공개 레포지토리에서는 GitHub Actions 사용량이 과금되지 않으므로 1시간 간격 실행에도 비용이 들지 않습니다. 비공개 레포지토리라면 무료 티어가 월 2,000분이고 실행마다 1분 단위로 올림 과금되므로, 1회 실행이 약 10초라도 1시간 간격이면 월 ~720분을 사용합니다.
